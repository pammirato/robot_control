#ifndef __SIMPLE_GRID_MOTION_SERVICE_H__
#define __SIMPLE_GRID_MOTION_SERVICE_H__
...
class SimpleGridMotionService : SimpleGridMotion
{
...
//    Point ** goal_points;
    ...
    ros::ServiceClient kinect_publish_client;
